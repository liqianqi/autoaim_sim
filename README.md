...
RoboMaster 步兵自瞄仿真：MuJoCo 场景 + 机载相机共享内存，可接检测 / PnP / 跟踪。在AI和各路开源的帮助下用了一天半时间，我脱离RM有几年了，一直忙自己的事情，前几天才突然有要不要做做RM自瞄仿真想法，恰巧这几天碰了碰mujuco，就整了整这个程序。如果有人看到并且帮助了你们那真是很好了。因为现在RM自瞄水平都非常高，这个程序在RM开源上肯定相当之简陋，所以想了想还是不放到论坛了。
